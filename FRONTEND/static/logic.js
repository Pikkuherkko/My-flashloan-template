...
const flashoanContractAddress = "0x157a926EB410f72184E964Dcc98f7F7A42766241";
const mockArbitrageAddress = "0x8b241203ab2abb9a90E0a494F8BA3437b5121673";
const mockArbitrageABI = [
  {
    inputs: [
      { internalType: "uint256", name: "_requiredFunds", type: "uint256" },
    ],
    ...
    inputs: [
      {
        indexed: false,
        internalType: "uint256",
        name: "previousRequiredFunds",
        type: "uint256",
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "newRequiredFunds",
        type: "uint256",
      },
    ],
    name: "RequiredFundsChanged",
    type: "event",
  },
  {
    inputs: [],
...
const flasloanABI = [
  {
    inputs: [
      ...
      { internalType: "address", name: "_arbitrageContract", type: "address" },
    ],
    stateMutability: "nonpayable",
    type: "constructor",
    name: "constructor",
...
async function populateArbitrage() {
  document.getElementById("requiredAmount").value =
    (await getRequiredAmount()) / 1e18;
  document.getElementById("arbitrageAmount").value =
    (await getArbitrageAmount()) / 1e18;
}
...
async function flashloan() {
  const web3 = await Moralis.enableWeb3();
  const amount = await Moralis.Units.Token(
  ...
  window.alert("operation concluded with hash " + flashloanReceipt["hash"]);
...
async function withdraw() {
  ...
  window.alert("operation concluded with hash " + withdrawReceipt["hash"]);
